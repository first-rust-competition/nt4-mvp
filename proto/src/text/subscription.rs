...
pub struct GetValues {
    /// The identifiers the client wishes to recieve the values of
    ids: Vec<u32>,
    /// Additional options
...
pub struct GetValuesOptions {
    /// If this value is true, the server will send the CBOR message with a timestamp, otherwise there will be no timestamp
    /// associated with the returned value.
    timestamped: bool,
}
...
pub struct SubscribeOptions {
    ...
    /// This value defaults to false
    logging: bool,
    /// If true, the server will send timestamps with the CBOR updates.
    ///
    /// This value defaults to false.
    timestamped: bool,
}
